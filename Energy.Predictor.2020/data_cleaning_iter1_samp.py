...
#sample traindata
building_list_samp = pd.DataFrame({"building_id" : trainData['building_id'].unique()}).sample(frac=0.25)
trainData = trainData[trainData.building_id.isin(building_list_samp.building_id)]
